#!/usr/bin/env python3
"""
Standalone verification for SessionConfig (no external dependencies).
Loads the config module directly without going through app.models package.
"""
...
# Load session_config.py directly
config_file = Path("app/models/session_config.py")
...
# Extract classes
SessionConfig = namespace['SessionConfig']
BacktestConfig = namespace['BacktestConfig']
SessionDataConfig = namespace['SessionDataConfig']
HistoricalConfig = namespace['HistoricalConfig']
HistoricalDataConfig = namespace['HistoricalDataConfig']
GapFillerConfig = namespace['GapFillerConfig']
TradingConfig = namespace['TradingConfig']
APIConfig = namespace['APIConfig']
...
if __name__ == "__main__":
    print("=" * 60)
    print("SessionConfig Verification (Standalone)")
    print("=" * 60)
